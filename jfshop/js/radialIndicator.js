...
;(function ($, window, document) {
    ...
    radialIndicator.defaults = {
        ...
        barColor: {0 : "#fff", 100: '#3db9e7'}, //filled bar color , can be a range also having different colors on different value like {0 : "#ccc", 50 : '#333', 100: '#000'}
        format: '##,#', //format indicator numbers, can be a # formator ex (##,###.##) or a function
        frameTime: 10, //miliseconds to move from one frame to another
        frameNum: null, //Defines numbers of frame in indicator, defaults to 100 when showing percentage and 500 for other values
        fontColor: "#3db9e7", //font color
        fontFamily: null, //defines font family
        fontWeight: 'normal', //defines font weight
        fontSize : 20, //define the font size of indicator number
