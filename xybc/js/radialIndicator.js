...
;(function ($, window, document) {
    ...
    radialIndicator.defaults = {
        ...
        barBgColor: '#d5d5d5', //unfilled bar color
        barColor: '#447124', //filled bar color , can be a range also having different colors on different value like {0 : "#ccc", 50 : '#333', 100: '#000'}
